...
window.addEventListener('pointerdown',ev=>{
 ...
 opDragClean();opHold={el,mid:el.dataset.person,id:ev.pointerId,x:ev.clientX,y:ev.clientY};opHold.mouse=ev.pointerType==='mouse';opHold.timer=setTimeout(opDragStart,150);
},true);
...
window.addEventListener('touchstart',ev=>{
 ...
 const t=ev.touches[0];opDragClean();opHold={el,mid:el.dataset.person,id:t.identifier,x:t.clientX,y:t.clientY,touch:true};opHold.timer=setTimeout(opDragStart,150);
