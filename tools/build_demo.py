...
def build(destination=None):
 ...
 for name in ['transport.js','domain.js','base.js','app.js','workflow.js','calendar.js','experience.js','operations.js']:
  text=(ROOT/'web'/name).read_text(encoding='utf-8')
  if name in ['app.js','workflow.js','calendar.js','experience.js','operations.js']:text=text.replace("location.protocol==='file:'||url.searchParams.has('demo')",'true')
